...
function NewsletterStrip({
  ...
  setEmailHovered: (v: boolean) => void
}) {
  return (
    <div
      data-speed="0.85"
    ...
    >
      <div style={{ overflow: 'hidden' }}>
        ...
        />
        <AnimatedText
          text="Get product updates and legal AI insights."
          delay={80}
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={{
            ...
            alignItems: 'center',
            gap: 8,
            backgroundColor: emailHovered ? '#F26522' : '#fff',
            color: emailHovered ? '#fff' : '#111827',
            border: 'none',
            borderRadius: 9999,
            padding: '10px 20px',
            fontSize: 13,
  ...
  return (
    <footer id="contact" style={{ backgroundColor: '#ffffff', borderTop: '1px solid #f3f4f6' }}>
      <div style={{ maxWidth: 1440, margin: '0 auto', paddingLeft: PX, paddingRight: PX, paddingTop: 'clamp(48px,6vw,80px)', paddingBottom: 'clamp(40px,5vw,64px)' }}>
        ...
        {/* Newsletter strip */}
        <NewsletterStrip emailHovered={emailHovered} setEmailHovered={setEmailHovered} />
      </div>
